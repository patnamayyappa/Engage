...
{
    public static class DomEngineAccount
    {
        [FunctionName("DomEngineAccount")]
        public static void Run([TimerTrigger("%DomEngineAccountSchedule%")]TimerInfo myTimer, TraceWriter log, ExecutionContext context)
        {
            ...
            domService.ProcessDomAssignment("account", CommonIocRegistrations.GetNewOrganizationServiceInstance());
        }
    }
}
