...
{
    public static class DomEngineContact
    {
        [FunctionName("DomEngineContact")]
        public static void Run([TimerTrigger("%DomEngineContactSchedule%")]TimerInfo myTimer, TraceWriter log, ExecutionContext context)
        {
            ...
            domService.ProcessDomAssignment("contact", CommonIocRegistrations.GetNewOrganizationServiceInstance());
        }
    }
}
