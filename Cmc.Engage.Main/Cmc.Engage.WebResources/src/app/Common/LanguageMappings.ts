module CampusManagement.LanguageMappings {
	let languages = {
		cultureInfo:
		{
	...
	export function getLocale (lcid) {
		if (typeof languages.cultureInfo[lcid] == 'undefined') { return ""; }
		else { return languages.cultureInfo[lcid].Locale; }
	};

	export function getCultureName(lcid) {
		if (typeof languages.cultureInfo[lcid] == 'undefined') { return ""; }
		else { return languages.cultureInfo[lcid].CultureName; }
	};

	export function getLanguageRegion (lcid) {
		if (typeof languages.cultureInfo[lcid] == 'undefined') { return ""; }
		else { return languages.cultureInfo[lcid].LanguageRegion; }
	};
