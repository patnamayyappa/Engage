...
(function (CampusManagement) {
    var CommonInboundInterestLogic;
    (function (CommonInboundInterestLogic) {
        ...
        CommonInboundInterestLogic.onLoad = onLoad;
        ...
        function filterSubCategoryByCategory(executionContext) {
            var formContext = executionContext.getFormContext(), subCategory = formContext.getAttribute('cmc_sourcesubcategoryid'), subCategoryControl = formContext.getControl('cmc_sourcesubcategoryid'), category = formContext.getAttribute('cmc_sourcecategoryid'), referringContact = formContext.getControl('cmc_sourcereferringcontactid'), referringOrganization = formContext.getControl('cmc_sourcereferringorganizationid'), referringStaff = formContext.getControl('cmc_sourcereferringstaffid'), referringContactAttribute = formContext.getAttribute('cmc_sourcereferringcontactid'), referringOrganizationAttribute = formContext.getAttribute('cmc_sourcereferringorganizationid'), referringStaffAttribute = formContext.getAttribute('cmc_sourcereferringstaffid'), categoryLookup;
            var controls = [];
    ...
    })(CommonInboundInterestLogic = CampusManagement.CommonInboundInterestLogic || (CampusManagement.CommonInboundInterestLogic = {}));
