...
(function (CampusManagement) {
    ...
    (function (cmc_officehours) {
        ...
        function onLoad(executionContext) {
            var formContext = executionContext.getFormContext(), durationAttr = formContext.getAttribute("cmc_duration"), enddateAttr = formContext.getAttribute("cmc_enddate"), startdateAttr = formContext.getAttribute("cmc_startdate"), endtimeAttr = formContext.getAttribute("cmc_endtime"), starttimeAttr = formContext.getAttribute("cmc_starttime");
            if (durationAttr) {
        ...
        cmc_officehours.onLoad = onLoad;
        function checkForValidDuration(executionContext) {
            var formContext = executionContext.getFormContext(), duration = formContext.getAttribute("cmc_duration").getValue(), isDurationValid;
            if (!duration) {
                return;
            }
        ...
        function dateIntervalIsValid(executionContext) {
            var formContext = executionContext.getFormContext(), enddate = formContext.getAttribute("cmc_enddate").getValue(), startdate = formContext.getAttribute("cmc_startdate").getValue(), dateDifference;
        ...
        function timeIntervalIsValid(executionContext) {
            var formContext = executionContext.getFormContext(), endtime = formContext.getAttribute("cmc_endtime").getValue(), starttime = formContext.getAttribute("cmc_starttime").getValue(), dateDifference;
    ...
    })(cmc_officehours = CampusManagement.cmc_officehours || (CampusManagement.cmc_officehours = {}));
