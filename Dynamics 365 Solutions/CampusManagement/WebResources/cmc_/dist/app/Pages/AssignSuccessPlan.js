...
(function (CampusManagement) {
    var AssignSuccessPlan;
    (function (AssignSuccessPlan) {
        var _studentIds, _fromForm, _selectedItem, _translations = {}, localizedStrings;
        ...
        AssignSuccessPlan.executeOnLoad = executeOnLoad;
        ...
        AssignSuccessPlan.cancel = cancel;
        ...
        function assign() {
            var students = [], successPlanTemplate, i, len;
            successPlanTemplate = _selectedItem;
            if (!successPlanTemplate || !successPlanTemplate.cmc_successplantemplateid) {
                openAlertDialog(localizedStrings.assignSuccessPlanDialog_SelectSuccessPlanTemplateMessage).then(function () {
        ...
        AssignSuccessPlan.assign = assign;
    ...
    })(AssignSuccessPlan = CampusManagement.AssignSuccessPlan || (CampusManagement.AssignSuccessPlan = {}));
