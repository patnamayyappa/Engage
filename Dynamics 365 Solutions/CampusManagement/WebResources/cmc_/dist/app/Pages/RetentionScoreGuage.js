...
(function (CampusManagement) {
    var RetentionScoreGauge;
    (function (RetentionScoreGauge) {
        ...
        function executeOnLoad() {
            ...
            $((document)).ready(function () {
                ...
                // for it.
                currentRetentionScore = parent.Xrm.Page.getAttribute("cmc_currentretentionscore") ? parent.Xrm.Page.getAttribute("cmc_currentretentionscore").getValue() : 0, fetchXml = [
                    '<fetch count="1">',
                ...
                Xrm.WebApi.retrieveMultipleRecords('cmc_retentionscorehistory', '?fetchXml=' + fetchXml)
                    ...
                    var latestRetentionHistory = results.entities.length > 0 ? results.entities[0] : {}, greenThreshold = latestRetentionHistory['studentGroup.cmc_greenscorethreshold'], yellowThreshold = latestRetentionHistory['studentGroup.cmc_yellowscorethreshold'], redThreshold = latestRetentionHistory['studentGroup.cmc_redscorethreshold'];
        ...
        RetentionScoreGauge.executeOnLoad = executeOnLoad;
    ...
    })(RetentionScoreGauge = CampusManagement.RetentionScoreGauge || (CampusManagement.RetentionScoreGauge = {}));
