...
(function (CampusManagement) {
    var ribbon;
    (function (ribbon) {
        var cmc_SuccessPlanTemplate;
        (function (cmc_SuccessPlanTemplate) {
            ...
            cmc_SuccessPlanTemplate.copy = copy;
            function addAttributeToParameters(parameters, attribute, index) {
                var attName = attribute.getName(), attType = attribute.getAttributeType(), attValue = attribute.getValue();
        ...
        })(cmc_SuccessPlanTemplate = ribbon.cmc_SuccessPlanTemplate || (ribbon.cmc_SuccessPlanTemplate = {}));
