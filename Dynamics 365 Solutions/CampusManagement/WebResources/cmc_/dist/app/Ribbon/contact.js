...
(function (CampusManagement) {
    ...
    (function (ribbon) {
        var Contact;
        (function (Contact) {
            function assignSuccessPlan(studentIds, fromForm) {
            ...
            Contact.assignSuccessPlan = assignSuccessPlan;
            function assignSuccessPlanForm() {
                assignSuccessPlan([Xrm.Page.data.entity.getId()], true);
            }
            Contact.assignSuccessPlanForm = assignSuccessPlanForm;
            ...
            Contact.predictRetention = predictRetention;
            function navigateToDegreePlanningUrl() {
                ...
                var fetch = ['<fetch top="1">',
                    ...
                    '<filter type="and">',
                    '<condition attribute="cmc_configurationname" operator="eq" value="Degree Planning URL" />',
                    '</filter>',
                    '</entity>',
                    '</fetch>'
                ].join('');
                ...
                Xrm.WebApi.retrieveMultipleRecords('cmc_configuration', '?fetchXml=' + fetch)
                    .then(function (result) {
                        ...
                        var url = configuration["cmc_value"];
            ...
            Contact.navigateToDegreePlanningUrl = navigateToDegreePlanningUrl;
        ...
        })(Contact = ribbon.Contact || (ribbon.Contact = {}));
