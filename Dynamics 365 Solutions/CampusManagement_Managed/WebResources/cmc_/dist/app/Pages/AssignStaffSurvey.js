...
(function (CampusManagement) {
    var AssignStaffSurvey;
    (function (AssignStaffSurvey) {
        var _staffIds, _fromForm, _selectedItem, _surveyIds, _translations = {}, localizedStrings;
        ...
        AssignStaffSurvey.executeOnLoad = executeOnLoad;
        ...
        function assign() {
            var staff = [], StaffCourseTemplates, i, len;
        ...
        AssignStaffSurvey.assign = assign;
        function cancel(page) {
            removeLocalStorageValues(page);
            closeWindow();
        }
        AssignStaffSurvey.cancel = cancel;
    ...
    })(AssignStaffSurvey = CampusManagement.AssignStaffSurvey || (CampusManagement.AssignStaffSurvey = {}));
