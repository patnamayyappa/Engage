    ...
    (function (ribbon) {
        ...
        (function (appointment) {
            var _inviteeStatuses = {
                accepted: 175490001,
                declined: 175490002
            }, _acceptDeclineRunning, localizedStrings = {
            ...
            appointment.declineAppointment = declineAppointment;
            function acceptAppointment() {
                setInviteStatus(_inviteeStatuses.accepted);
            }
            appointment.acceptAppointment = acceptAppointment;
            function isCurrentUserOwner() {
                ...
                var ownerId = Xrm.Page.getAttribute('ownerid'), ownerIdValue;
                if (!ownerId) {
                    return false;
                }
            ...
            appointment.isCurrentUserOwner = isCurrentUserOwner;
            ...
            function acceptAppointmentSubgrid(selectedItems, grid) {
                processSubgridList(selectedItems, grid, "accept");
            }
            appointment.acceptAppointmentSubgrid = acceptAppointmentSubgrid;
            function declineAppointmentSubgrid(selectedItems, grid) {
                processSubgridList(selectedItems, grid, "decline");
            }
            appointment.declineAppointmentSubgrid = declineAppointmentSubgrid;
            function processSubgridList(selectedItems, grid, acceptOrDecline) {
                var retrieveLoadingMessagePromise, promises = [], i, len;
            ...
            function multiLingualAlert(message, grid) {
                ...
                Xrm.Navigation.openAlertDialog(alertStrings, null).then(function () { if (grid) {
                    grid.refresh();
                } });
            }
        })(appointment = ribbon.appointment || (ribbon.appointment = {}));
